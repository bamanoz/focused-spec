...
- **EVIDENCE**: `planned:go-unit::./auth::TestBlockedAccountWithValidCredentials`
- **EVIDENCE**: `planned:pytest-functional::tests/functional/test_auth.py::test_blocked_account_with_valid_credentials`
